...
class TopWaveWidget extends StatefulWidget {
  const TopWaveWidget(
      {super.key,
      required this.size,
  ...
  @override
  State<TopWaveWidget> createState() => _TopWaveWidget();
}

class _TopWaveWidget extends State<TopWaveWidget> with TickerProviderStateMixin {
